...
class KiCADConfig:
    ...
    def __init__(self):
        ...
        self.no_title_block_names = {
            "untitled", "blank schematic", "", "single_resistor", "two_resistors",
            "single_wire", "single_label", "single_hierarchical_sheet"
        }
    ...
    def get_property_position(self, property_name: str, component_pos: Tuple[float, float], 
                            offset_index: int = 0) -> Tuple[float, float, float]:
        """
        ...
        if property_name == "Reference":
            return (x + self.properties.reference_x, 
                   y + self.properties.reference_y, 0)
        elif property_name == "Value":
            return (x + self.properties.value_x,
                   y + self.properties.value_y, 0)
            ...
            return (x + self.properties.reference_x, 
                   y + self.properties.value_y + (self.properties.hidden_property_offset * offset_index), 0)
