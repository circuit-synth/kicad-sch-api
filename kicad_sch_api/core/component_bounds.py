...
class BoundingBox:
    ...
    def overlaps(self, other: 'BoundingBox') -> bool:
        ...
        return not (self.max_x < other.min_x or  # this right < other left
                   self.min_x > other.max_x or  # this left > other right  
                   self.max_y < other.min_y or  # this bottom < other top
                   self.min_y > other.max_y)    # this top > other bottom
...
def get_component_bounding_box(component: SchematicSymbol, include_properties: bool = True) -> BoundingBox:
    """
...
def check_path_collision(start: Point, end: Point, obstacles: List[BoundingBox], 
                        clearance: float = 1.27) -> bool:
    """
