...
This demo showcases the cool and powerful features of kicad-sch-api.
...
# Connect the circuit
sch.add_wire(start=(100, 60), end=(100, 70))  # +5V to R1
sch.add_wire(start=(100, 80), end=(100, 90))  # R1 to output
sch.add_wire(start=(100, 100), end=(100, 110))  # R2 to GND
sch.add_wire(start=(100, 90), end=(110, 90))  # Output tap

# Add output label
sch.add_label(text="VOUT", position=(110, 90))
...
# ============================================================
# DEMO 2: Duplicate and Layout Circuits Programmatically
# ============================================================
print("=" * 60)
...
num_dividers = 10
spacing_x = 50  # Spacing between dividers in mm
start_x = 50
start_y = 80
...
for i in range(num_dividers):
    ...
    sch.add_wire(start=(x, y - 20), end=(x, y - 10))  # +5V to R1
    sch.add_wire(start=(x, y), end=(x, y + 10))  # R1 to output
    sch.add_wire(start=(x, y + 20), end=(x, y + 30))  # R2 to output
    sch.add_wire(start=(x, y + 10), end=(x, y + 20))  # Output connection
    sch.add_wire(start=(x, y + 30), end=(x, y + 40))  # Output to GND

    # Add label for this output
    sch.add_label(text=f"OUT{i}", position=(x + 5, y + 15))
...
print(f"   This would take 10+ minutes to create manually!")
print()


# ============================================================
# DEMO 3: Bulk Operations - Update All Resistors at Once
# ============================================================
print("=" * 60)
...
sch = ksa.Schematic.load("demo_2_array.kicad_sch")
...
print(f"   Time to update: < 1 second (would take minutes manually)")
print()
...
sch = ksa.Schematic.load(input_file)
...
print(f"   File can be opened in KiCad without any issues")
print()
...
print()
print("Try opening these files in KiCad 8 to see the results!")
print()
print("Key takeaways:")
print("  ✓ Programmatic circuit creation saves massive amounts of time")
print("  ✓ Bulk operations on components are trivial with Python")
print("  ✓ Perfect round-trip format preservation")
print("  ✓ Create complex layouts with loops and math")
print()
print("Next steps:")
print("  - Read the docs: https://github.com/circuit-synth/kicad-sch-api")
print("  - Install Claude Code commands: ksa_claude_setup")
print("  - Build your own circuits programmatically!")
print()
'''
...
def main(argv: Optional[list] = None) -> int:
    ...
    try:
        ...
        print(f"✓ Demo showcases: circuit duplication, programmatic layout, bulk operations")
        print()
        print(f"The demo will create 4 example KiCad schematics showing off:")
        print(f"  1. Basic circuit creation")
        print(f"  2. Array generation (10 circuits at once!)")
