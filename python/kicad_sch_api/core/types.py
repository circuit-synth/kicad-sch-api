...
class SchematicPin:
    ...
    def __post_init__(self):
        ...
        self.pin_shape = PinShape(self.pin_shape) if isinstance(self.pin_shape, str) else self.pin_shape
...
class SchematicSymbol:
    ...
    def get_pin_position(self, pin_number: str) -> Optional[Point]:
        ...
        return Point(
            self.position.x + pin.position.x,
            self.position.y + pin.position.y
        )
...
class Wire:
    ...
    def __post_init__(self):
        ...
        self.wire_type = WireType(self.wire_type) if isinstance(self.wire_type, str) else self.wire_type
...
class Label:
    ...
    def __post_init__(self):
        ...
        self.label_type = LabelType(self.label_type) if isinstance(self.label_type, str) else self.label_type
