...
# Add repository root to path to import kicad_sch_api
sys.path.insert(0, str(Path(__file__).parent.parent.parent.parent))

import kicad_sch_api as ksa
from examples.parametric_circuits.mm_based.test_circuit_5_stm32_microprocessor import create_stm32_microprocessor
...
def main():
    ...
    circuit3_x = START_X + CIRCUIT_GRID * 2.3  # Moved further right
    circuit3_y = START_Y
