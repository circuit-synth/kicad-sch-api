...
class TestElementRemoval:
    ...
    def test_hierarchical_label_removal(self):
        ...
        assert "hierarchical_labels" in sch._data and len(sch._data["hierarchical_labels"]) == 1, \
        ...
        assert "hierarchical_labels" not in sch._data or len(sch._data["hierarchical_labels"]) == 0, \
