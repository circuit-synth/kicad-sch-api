...
class TestComponentRemoval:
    ...
    def test_resistor_to_blank_removal(self):
        ...
        assert "Device:R" in str(sch._data.get("lib_symbols", {})), "Should have resistor lib_symbol"
        ...
        assert "lib_symbols" not in generated_blank or "Device:R" not in generated_blank, \
    ...
    def test_two_resistors_remove_one(self):
        ...
        assert "Device:R" in str(sch._data.get("lib_symbols", {})), \
