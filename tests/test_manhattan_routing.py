...
class TestManhattanRouting:
    ...
    def test_manhattan_routing_strategies(self):
        ...
        path_h = router.route_between_points(start, end, [obstacle], 
                                           strategy=RoutingStrategy.SHORTEST)
        
        # Test clearance strategy  
        path_v = router.route_between_points(start, end, [obstacle],
                                           strategy=RoutingStrategy.CLEARANCE)
